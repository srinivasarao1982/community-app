(function (module) {
    mifosX.controllers = _.extend(module, {
        JlgSavingsAccountGroupController: function (scope, resourceFactory, location, routeParams, dateFilter, $rootScope) {
            ...
            resourceFactory.groupResource.get({groupId: scope.groupId, associations:'activeClientMembers'}, function (data) {
            ...
            scope.changeProduct=function(productid){
                resourceFactory.savingsTemplateResource.get({groupId: scope.groupId,productId:productid,staffInSelectedOfficeOnly:'true'},function (data) {
